 ...
 * onibus cadastrados no banco de dados que tenham o modelo informado ou parte dele.
 * 
 * @author João Victor
 * @data 01/12/2020
 */

@WebServlet("/servletconsultapormodeloonibus")
public class ServletConsultaPorModeloOnibus extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private Gson gson;

	public ServletConsultaPorModeloOnibus() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		lista = oc.buscaOnibusPorModelo(pesquisar);
